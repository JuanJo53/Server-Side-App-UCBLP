...
const ContenidoModuloPersonalizadoController_1 = require("../controllers/ContenidoModuloPersonalizadoController");
class ContenidoModuloPersonalizadoRoutes {
    ...
    config() {
        this.router.get('/teacher/cutson/module/content', ContenidoModuloPersonalizadoController_1.contenidoModuloPersonalizadoController.listarContenido);

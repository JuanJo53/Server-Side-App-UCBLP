...
class ForoRoutes {
    ...
    config() {
        ...
        this.router.get('/teacher/forums', VerifyToken_1.TokenValidation, ForoController_1.foroController.listarForos);
        this.router.put('/teacher/forums/:id', VerifyToken_1.TokenValidation, ForoController_1.foroController.modificarForos);
